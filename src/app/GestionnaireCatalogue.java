...
public final class GestionnaireCatalogue 
{
	...
	public static boolean enregistrerAchat(String nomProduit, String quantite) 
	{
		...
		if(storageFactory.createProduitDAO() == null)
			...
			I_Produit produitAvecNouveauStock = new Produit(produit.getNom(), produit.getPrixUnitaireHT(), produit.getQuantite() + intQuantite, Catalogue.getCatalogue().getNom());
	...
	public static boolean ajouterProduit(String nomProduit, String prixHT, String quantite) 
	{
		...
		if(storageFactory.createProduitDAO() == null)
			...
			if(catalogue.getProduit(nomProduit) != null) {
				...
				I_Produit produit = new Produit(nomProduit, prix, intQuantite, Catalogue.getCatalogue().getNom());
