...
public class CatalogueTest {
	...
	@Before
	public void setUp() {
		cat = new Catalogue("CatalogueTest");
		Catalogue.getCatalogue("CatalogueTest");
		cat.clear();
	}
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecAucunChiffreApresVirgule() {
		String resultatAttendu = "Mars - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 5 - catalogue : CatalogueTest" + "\n" +
								 "Treets - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 4 - catalogue : CatalogueTest" + "\n" +
								 "Raider - prix HT : 1,00 € - prix TTC : 1,20 € - quantité en stock : 10 - catalogue : CatalogueTest" + "\n" +
								 "\n" +
	...
	public void testToString_CatalogueAvecDesProduits_AvecDesEspaceDansLesNomsDesProduit() {
		String resultatAttendu = "Mars - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 5 - catalogue : CatalogueTest" + "\n" +
				 "Treets - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 4 - catalogue : CatalogueTest" + "\n" +
				 "Kit Kat - prix HT : 1,00 € - prix TTC : 1,20 € - quantité en stock : 10 - catalogue : CatalogueTest" + "\n" +
				 "\n" +
				 "Montant total TTC du stock : 120,00 €";
		cat.addProduit("Mars ", 10, 5);
		cat.addProduit(" Treets", 10, 4);
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecUnChiffreApresVirgule() {
		String resultatAttendu = "Mars - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 5 - catalogue : CatalogueTest" + "\n" +
								 "Treets - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 4 - catalogue : CatalogueTest" + "\n" +
								 "Raider - prix HT : 1,00 € - prix TTC : 1,20 € - quantité en stock : 10 - catalogue : CatalogueTest" + "\n" +
								 "Twix - prix HT : 10,45 € - prix TTC : 12,54 € - quantité en stock : 5 - catalogue : CatalogueTest" + "\n" +
								 "\n" +
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecDeuxChiffresApresVirgule() {
		String resultatAttendu = "Mars - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 5 - catalogue : CatalogueTest" + "\n" +
								 "Treets - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 4 - catalogue : CatalogueTest" + "\n" +
								 "Raider - prix HT : 1,00 € - prix TTC : 1,20 € - quantité en stock : 10 - catalogue : CatalogueTest" + "\n" +
								 "Twix - prix HT : 10,40 € - prix TTC : 12,48 € - quantité en stock : 1 - catalogue : CatalogueTest" + "\n" +
								 "\n" +
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecTroisChiffresApresVirguleArrondiInferieur() {
		String resultatAttendu = "Mars - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 5 - catalogue : CatalogueTest" + "\n" +
								 "Treets - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 4 - catalogue : CatalogueTest" + "\n" +
								 "Raider - prix HT : 1,00 € - prix TTC : 1,20 € - quantité en stock : 10 - catalogue : CatalogueTest" + "\n" +
								 "Twix - prix HT : 10,47 € - prix TTC : 12,56 € - quantité en stock : 1 - catalogue : CatalogueTest" + "\n" +
								 "\n" +
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecTroisChiffresApresVirguleArrondiSuperieur() {
		String resultatAttendu = "Mars - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 5 - catalogue : CatalogueTest" + "\n" +
								 "Treets - prix HT : 10,00 € - prix TTC : 12,00 € - quantité en stock : 4 - catalogue : CatalogueTest" + "\n" +
								 "Raider - prix HT : 1,00 € - prix TTC : 1,20 € - quantité en stock : 10 - catalogue : CatalogueTest" + "\n" +
								 "Twix - prix HT : 10,47 € - prix TTC : 12,56 € - quantité en stock : 2 - catalogue : CatalogueTest" + "\n" +
								 "\n" +
	...
	private I_Produit createProduit(String nom, double prixHT, int quantite) {
		try {
			return new Produit(nom,prixHT,quantite,"CatalogueTest");
		}
